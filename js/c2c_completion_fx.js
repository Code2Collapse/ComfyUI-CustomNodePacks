...
const COLORS = ["var(--c2c-red)", "var(--c2c-peach)", "var(--c2c-yellow)", "var(--c2c-okSoft)", "var(--c2c-blue)", "var(--c2c-mauve)", "var(--c2c-pink)"];
const NUM_PIECES = 80;
...
function _ensureCanvas() {
    ...
    // Use setProperty for CSS-var values; style.zIndex setter rejects non-numeric strings.
    c.style.setProperty("z-index", "var(--c2c-z-toast, 100002)");
