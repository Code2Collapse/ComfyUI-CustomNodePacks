    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "pos_points": ("STRING", {"multiline": True, "default": "", "tooltip": "Positive points (legacy text widget). KJ {'positive':[[x,y]]} or MEC [{'x','y','label':1}] both accepted. Prefer wiring positive_coords slot."}),
                "neg_points": ("STRING", {"multiline": True, "default": "", "tooltip": "Negative points (legacy text widget). Prefer wiring negative_coords slot."}),
                ...
                "text_prompt": ("STRING", {"multiline": True, "default": "", "tooltip": "Open-vocabulary text prompt (SAM3, GroundingDINO, VideoMaMa)."}),
